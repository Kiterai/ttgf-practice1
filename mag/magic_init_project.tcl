...
# https://raw.githubusercontent.com/TinyTapeout/tt-support-tools/main/tech/gf180mcuD/def/analog/tt_analog_1x2.def

# Change the settings below to match your design:
# ------------------------------------------------
set TOP_LEVEL_CELL     tt_um_kiterai_current_dac
...
proc draw_power_stripe {name x} {
    ...
    box $x 5um $x 320.36um
    box width $POWER_STRIPE_WIDTH
    paint metal4
    label $name FreeSans 0.25u -metal4
    port make
